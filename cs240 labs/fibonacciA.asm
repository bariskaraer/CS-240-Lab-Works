...
123: CPI 306 360 // tmp2 = stack[ptr];
124: ADD 306 293 // tmp2 = stack[ptr] - 2;
125: ADDi 350 2 // tmp = ptr + 2;
126: CPIi 350 306 // stack[ptr + 3] = stack[ptr] - 2;
127: ADDi 350 1 // tmp = ptr + 1; 
128: CPIi 350 291 //stack[ptr + 4]=0;
129: ADDi 350 1 // tmp = ptr + 1; 
...
138: ADD 700 350 //lastresult += stack[ptr + 1];
139: ADD 360 292 // ptr = ptr - 3;
140: CP 350 360 // tmp = ptr;
141: ADDi 350 5 // tmp = ptr + 5;
142: CPI 306 350 // tmp2 = stack[ptr+5];
143: BZJi 306 0 // goto stack[ptr+5];
