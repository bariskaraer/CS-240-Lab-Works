...
3: BZJ 82 134 // if(temp == 0) go to end
...
10: CP 133 135
11: BZJi 86 0 // go to func
12: ADDi 102 1 // increment k by 1
13: BZJi 87 0 // return to loop
14: BZJi 15 0
15: 14
...
410: CPi 500 0 // k = 0 for other function calls
411: CPIi 133 303 
412: BZJi 70 0 // go to caller
